---
title: Kubernetes with CA
date: 2019-01-05 10:35:48
tags:
  - k8s
description: 部署带CA的Kubernetes集群
---

文中涉及到的文件，可到[github-kubernetes-starter][4]获取。

# 完整集群部署 - kubernetes-with-ca
## 1. 理解认证授权
#### 1.1 为什么要认证
...
[4]: https://github.com/liuyi01/kubernetes-starter.git
